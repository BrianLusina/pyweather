...
from app.servers.mcp.rag.config import CHROMA_PERSIST_DIR

google_api_key = os.getenv("GOOGLE_GEMINI_API_KEY")


@mcp.tool()
def ingest_document(file_path: str, ctx: Context) -> str:
    """
...
@mcp.tool()
def query_rag_store(query: str, ctx: Context) -> str:
    """
