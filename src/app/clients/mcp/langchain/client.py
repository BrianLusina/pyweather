from app.clients.mcp.langchain.agent import create_graph
from app.clients.mcp.langchain.prompts_handler import list_prompts, handle_prompt
from app.clients.mcp.langchain.resource_handler import list_resources, handle_resource
...
server_configs = {
    "weather": {
        "command": "python",
        "args": ["app/servers/mcp/weather/server.py"],
        "transport": "stdio",
    },
    "tasks": {
        "command": "python",
        "args": ["app/servers/mcp/tasks/server.py"],
        "transport": "stdio",
    },
    "rag": {
        "command": "python",
        "args": ["app/servers/mcp/rag/server.py"],
        "transport": "stdio",
    },
}
